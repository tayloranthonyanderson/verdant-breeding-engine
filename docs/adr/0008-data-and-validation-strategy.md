# ADR-0008 — Data & validation strategy: three sources, G2F north star, maize beachhead

**Status:** Accepted (2026-06-11)

## Context
There is **no proprietary phenotype trial data** and the founder's maize genomic library is
...
1. **Simulator → correctness proof.** Its superpower is *known ground truth*: prove BLUPs recover true
   ...
   maize-flavored** for the founder's gut-check intuition.
...
- **Maize remains the product beachhead / marketing story;** the maize demo set (founder's genomes + a
...
- Cost: developing on maize while selling maize loses some daily domain intuition — mitigated by the
  maize-flavored simulator.
