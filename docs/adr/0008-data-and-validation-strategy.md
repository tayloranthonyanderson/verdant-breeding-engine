...
## Context
There is **no proprietary phenotype trial data** and the author's self-collected maize genomic library is
**unpaired with phenotypes**, so it cannot validate genomic prediction on its own. "Validate the core
