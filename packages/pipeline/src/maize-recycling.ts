// Within-pool recycling facet (ADR-0024 mode 2) for the maize corpus. For each heterotic pool it builds
...
import { loadInbreds, markerPanel } from './maize-corpus';
...
export function buildMaizeRecycling(opts: { nCrosses?: number; selProp?: number } = {}): RecyclingByPool | null {
